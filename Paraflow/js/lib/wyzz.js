...
editstyle = 'js/lib/wyzzstyles/editarea.css';

// Do we want to try to clean the code to emulate xhtml? 1=Yes, 0=No
xhtml_out = 1;

// Style Sheet
document.write('<link rel="stylesheet" type="text/css" href="js/lib/wyzzstyles/style.css">\n');

// TOOLBARS ARRAYS
// Order of available commands in toolbar
// Remove from this any buttons not required in your application
var buttonName = new Array("font","headers","separator","bold","italic","underline","separator","cut","copy","paste","separator","justifyleft","justifycenter","justifyright","justifyfull","indent","outdent","separator","insertunorderedlist","insertorderedlist");

// Order of available commands in toolbar2
// Remove from this any buttons not required in your application
var buttonName2 = new Array("specialchar","separator","forecolor","backcolor","separator","inserthorizontalrule","separator","removeformat","separator","upsize","downsize","separator","link","insertimage","separator","undo","redo");
...
function insertImage(n) {
  ...
  var imgwidth = prompt('Please choose a image size(max 100):');
  imgwidth = (imgwidth < 100)?imgwidth:100;
  var theImage = '<img src="' + imgurl + '" title="' + imgtitle + '" style="width:' + imgwidth +'%;" />';
...
function make_wyzz(textareaID) {
  ...
  for (btn in buttonName2) {
    ...
    if(buttonName2[btn] == "separator") {
      ...
      toolbar2 += '<td style="width: 22px;"><img src="js/lib/wyzzicons/' +buttonName2[btn]+ '.gif" border=0 unselectable="on" title="' +buttonName2[btn]+ '" id="' +buttonName2[btn]+ '" class="button" onClick="formatText(this.id,\'' + n + '\');" onmouseover="if(className==\'button\'){className=\'buttonOver\'};" onmouseout="if(className==\'buttonOver\'){className=\'button\'};" unselectable="on" width="20" height="20"></td>';
      }
  }
  toolbar2 += '<td>&nbsp;</td></tr>';
...
// the foreground color picker
  ...
  toolbar2 += '<div id="colorpicker' + n + '" class="colorpicker" style="display:none">';
    ...
    toolbar2 += '<img class="closebutton" src="js/lib/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'colorpicker' + n + '\')"></div>';
  ...
  toolbar2 += '<img class="closebutton" src="js/lib/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'colorbackpicker' + n + '\')"></div>'; 
  // the font picker
  ...
  toolbar2 += '<img class="closebutton" src="js/lib/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'fontpicker' + n + '\')"></div>'; 
  ...
  toolbar2 += '</tr></table><br><img class="closebutton" src="js/lib/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'specialpicker' + n + '\')"></div>'; 
  // the header picker
  ...
  toolbar2 += '<img class="closebutton" src="js/lib/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'headerpicker' + n + '\')"></div>'; 
  ...
  toolbar2 += '<img class="closebutton" src="js/lib/wyzzicons/close.gif" border=0 onclick="closeColorPicker(\'helpbox' + n + '\')"></div></td></tr></table>';   
